...
└── src/
    ...
    └── docs/targets_and_data_zh.md  # MNIST data 与 targets 说明（中文示例，docs 目录）

## 文档

- `docs/linear计算过程.md` — 线性层计算过程说明（中文）。
- `docs/targets_and_data_zh.md` — 关于 MNIST `data` 与 `targets` 的详解与示例（中文）。
- `docs/targets_and_data_en.md` — `targets_and_data` 的英文完整指南（docs 目录）。
```
